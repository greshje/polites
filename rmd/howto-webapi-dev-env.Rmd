...
<p style="text-align: justify;">
  Eclipse can be installed by downloaded and running the installer available 
  <a href="https://www.dropbox.com/scl/fi/4ei174qjo9zknpkm3sxhf/eclipse-jee-2024-06-R-win32-x86_64.zip?rlkey=jqyl153992l9hiqgo80njju7t&st=a7ho98xo&dl=1">here</a>.
  Download this file, copy it to the _YES_POLITES folder, and extract it.
  Navigate to C:\\_YES_POLITES\\eclipse-jee-2024-06-R-win32-x86_64\\eclipse
  and click on eclipse.exe to start eclipse.
  Change the workspace to C:\\_YES_POLITES\\workspace.
</p>
