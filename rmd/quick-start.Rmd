...
<p style="text-align: justify;">
  Broadsea can be downloaded, configured, and started simply by starting Docker 
  and then running the install-broadsea.bat file found in _YES_POLITES/workspace. 
</p>
