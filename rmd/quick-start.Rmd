...
<p style="text-align: justify;">
  ...
  <a href="https://www.dropbox.com/scl/fi/boxqxjik8zqpsrsu3ojbv/YesPolitesInstaller-1.2.054.exe?rlkey=ncox07wqhhnnxfb8rttxh45it&dl=1">YesPolitesInstaller.exe</a>. 
...
<p style="text-align: justify;">
  ...
  <ul>
    ...
    <li>
      <p style="text-align: justify;">
        <b>Cygwin:</b>
        Install Cygwin by running the setup .exe file in C:\\_YES_POLITES\\tools\\cygwin
        <br/>
        Associate Cygwin with .sh files: 
        <ul>
          <li>Create an empty .sh file.</li>
          <li>Right click on the file and select run as.</li>
          <li>Select C:\\cygwin64\\bin\\mintty.exe as the application to use.</li>
          <li>Select Always.</li>
        </ul> 
      </p>
    </li>
...
<br/>
<!--
<a href="https://www.dropbox.com/scl/fi/boxqxjik8zqpsrsu3ojbv/YesPolitesInstaller-1.2.054.exe?rlkey=ncox07wqhhnnxfb8rttxh45it&dl=1">Version-1.2.054</a>
-->
